...
CREATE TABLE `address` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `address_chk_1` CHECK ((`state_code` between 0 and 49))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_chk_2` CHECK ((`user_type` between 0 and 1))
...
INSERT INTO `users` VALUES (1,'test@test.com',NULL,'Joe','Average','$2a$10$SITFastP29z7DOfPiMtfAuO/hR2BsfP3cVcIN1mANJE5foHNV4pGq',NULL,_binary '\0',NULL),(2,'test2@test.com',NULL,'John','Smith','$2a$10$BQoFttAMuP64LHegz8MzXO6Gex/2yZmqZpe4XX2QFeKmrOV3kRSVy',NULL,_binary '\0',NULL),(3,'test3@test.com',NULL,'Sally','Wade','$2a$10$6t8qbEk58RKMUdpfEZn3R.SVpe7xSEmPRmbZHQ/sbpDg46FrlWcHC',0,_binary '\0',NULL);
...
-- Dump completed on 2024-03-22 18:53:08
